...
<html>
    ...
    <body>
		...
		<form action="Add Movie Data.php" method="post" enctype="multipart/form-data">
                <tr>
                    <td colspan="3" align="center" id="addmovie">ADD MOVIE</td>
                </tr>
		<tr>
			<td>
				Select ID :
		...
		<tr>
			...
			<td colspan="2">
                ...
                <tr align="center">
                    <td colspan="3"><input type="submit" value="ADD MOVIE" id="sbt"/></td>
                </tr>
		</form>
            </table>
        </div>
