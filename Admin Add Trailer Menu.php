    ...
    <body>
        ...
        <div id="rpanel">
            <table border="0" align="center" cellspacing="20px">
                <form action="Trailer Data.php" method="post" enctype="multipart/form-data">
                <tr>
                    <td colspan="3" align="center" id="addmovie">ADD TRAILER</td>
                </tr>
                <tr>
                    <td>
                        Select ID :
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div id="video">
                            <input type="file" name="vfn"/>
                            <span id="vmsg">Browse File</span>
                        </div>
                    </td>
                </tr>   
                <tr align="center">
                    <td colspan="3"><input type="submit" value="ADD TRAILER" id="sbt"/></td>
                </tr>
                </form>
            </table>
        </div>
