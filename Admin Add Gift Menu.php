    ...
    <body>
        ...
        <div id="rpanel">
            <table border="0" align="center" cellspacing="20px">
                <form action="Gift Add Data.php" method="post" enctype="multipart/form-data">
                <tr>
                    <td colspan="3" align="center" id="addmovie">ADD GIFT CARD</td>
                </tr>
                <tr>
                    <td>
                        Select ID :
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" id="rate" name="price" maxlength="4"/>
                    </td>
                </tr>
                <tr align="center">
                    <td colspan="3"><input type="submit" value="ADD CARD" id="sbt"/></td>
                </tr>
                </form>
            </table>
        </div>
