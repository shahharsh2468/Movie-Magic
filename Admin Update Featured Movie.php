...
<html>
    ...
    <body>
		...
		<form action="Featured Poster Data.php" method="post" enctype="multipart/form-data">
                <tr>
                    <td colspan="3" align="center" id="addmovie">UPDATE POSTER</td>
                </tr>
		<tr>
			<td>
				Select ID :
			...
			<Td colspan="2">
                ...
                <tr align="center">
                    <td colspan="3"><input type="submit" value="UPDATE POSTER" id="sbt"/></td>
                </tr>
		</form>
            </table>
        </div>
